...
description: Analyse balance-sheet composition, movements, liquidity, leverage, classifications, and unusual balances. Use when the question focuses on financial position rather than only profit or cash flow.
---
...
Assess liquidity, solvency, leverage, asset quality, liability structure, and balance-sheet risks.
...
Use current ratio, quick ratio, net debt, and leverage ratios only where classifications and denominators are meaningful.
...
1. Confirm assets = liabilities + equity, allowing for rounding.
2. Calculate material liquidity and leverage ratios.
3. Analyse changes in cash, receivables, inventory, payables, debt, and equity.
4. Identify large or unusual balances and movements.
5. Assess short-term obligations against available liquid assets.
6. Highlight balance-sheet items requiring ageing, impairment, or classification review.
...
- negative working capital without a clear business-model explanation
- rapid AR or inventory growth versus revenue
- material related-party balances
- large unreconciled suspense or miscellaneous balances
