---
name: monthly-mis
description: Prepare or review a monthly management information pack covering performance, cash, working capital, KPIs, variances, and actions. Use for recurring management reporting.
---
...
Convert monthly financial and operational data into a concise management information pack.
...
KPIs must use stable definitions across periods. If definitions changed, do not present the trend as directly comparable.
...
1. Standardise monthly periods and units.
2. Create an executive KPI summary.
3. Show P&L performance with variance and trend.
4. Show cash, working capital, and liquidity.
5. Highlight operational KPIs linked to financial outcomes.
6. Identify decisions, owners, and actions for material issues.
...
- month labels or periods that do not align
- actual and budget using different account mappings
- KPIs with changing definitions
