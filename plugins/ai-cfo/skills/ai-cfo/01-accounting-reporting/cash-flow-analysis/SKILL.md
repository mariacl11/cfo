...
description: Analyse operating, investing, and financing cash flows and reconcile profit to cash movement. Use for cash-conversion, free-cash-flow, and falling-cash questions.
---
...
Explain operating, investing, and financing cash flows and reconcile profit to cash generation.
...
- cash flow statement or transaction data
- analysis period
- currency
...
Free cash flow must be defined explicitly. Do not assume EBITDA equals cash generation.
...
1. Reconcile opening cash to closing cash.
2. Separate operating, investing, and financing cash flows.
3. Bridge profit or EBITDA to operating cash flow.
4. Identify working-capital effects, capex, debt flows, equity flows, and one-offs.
5. Calculate free cash flow using a clearly stated definition.
6. Explain major divergences between accounting profit and cash movement.
...
- positive EBITDA but persistent negative operating cash flow
- large unexplained financing inflows supporting operations
- capex materially above depreciation without explanation
- cash balance inconsistent with bank or balance-sheet data
- large non-recurring cash items
