...
description: Analyse revenue, direct and shared costs, gross margin, contribution, mix, capacity use, and cash effects by product or service.
---
...
Compare products or services by revenue, direct cost, contribution, and economically relevant overheads.
...
Shared-cost allocations must state the allocation basis.
...
1. Map revenue and direct costs by product.
2. Calculate gross and contribution margins.
3. Allocate shared costs only when the basis is defensible and disclose the allocation method.
4. Identify cross-subsidy and mix effects.
5. Analyse volume versus margin.
6. Highlight products that consume cash or capacity disproportionately.
...
- high-revenue product with weak contribution
- arbitrary overhead allocation driving conclusions
- loss-making products justified only by top-line growth
