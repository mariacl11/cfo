...
description: Calculate accounting or cash breakeven, contribution, margin of safety, product-mix effects, and step-fixed costs. Use when the question asks what volume or revenue covers costs.
---
...
Calculate the operating volume, revenue, customers, or utilisation required to cover fixed and variable costs.
...
Breakeven volume = Fixed costs / Contribution per unit when contribution is positive and costs behave linearly within the relevant range.
...
1. Define the breakeven unit.
2. Calculate contribution per unit.
3. Calculate accounting breakeven and, if relevant, cash breakeven.
4. Handle multi-product mix using weighted contribution where appropriate.
5. Model step-fixed costs when capacity changes.
6. Show margin of safety.
...
- capacity below calculated breakeven volume
- fixed costs omitted because they are already committed
- mixed product economics collapsed into a misleading average
