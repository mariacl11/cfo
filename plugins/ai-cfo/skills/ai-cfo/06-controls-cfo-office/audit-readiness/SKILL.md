...
description: Assess audit readiness, map accounts to support, identify evidence gaps, prioritize likely audit issues, and produce an owner and due-date tracker without giving assurance.
---
...
Assess whether finance records, reconciliations, schedules, and evidence are organised enough for an efficient audit.
...
Readiness identifies gaps; it does not provide audit assurance.
...
1. Create a PBC-style request checklist.
2. Map material balance-sheet accounts to reconciliations.
3. Check availability of revenue, expense, payroll, tax, fixed asset, and debt support.
4. Identify unresolved prior-period items.
5. Prioritise gaps by materiality and expected audit impact.
6. Create owner and due-date tracker.
...
- material unreconciled accounts
- missing source documentation
- unsupported management estimates
- late intercompany differences
- policy treatment inconsistent across periods
