...
description: Review finance-process risks, preventive and detective controls, segregation of duties, approvals, reconciliations, evidence retention, and exception handling.
---
...
Review finance processes and identify weaknesses in approvals, segregation, access, reconciliations, and evidence.
...
- process descriptions or SOPs
- finance system context
...
Control recommendations should be proportionate to company size, transaction volume, and risk.
...
1. Map key finance processes.
2. Identify objectives and risks for each process.
3. Assess preventive and detective controls.
4. Review segregation of duties and approval thresholds.
5. Check evidence retention and exception handling.
6. Recommend proportionate control improvements.
...
- same person creates vendor and approves payment
- shared finance credentials
- no independent bank reconciliation
- manual journals without approval
- no evidence of approval despite policy
