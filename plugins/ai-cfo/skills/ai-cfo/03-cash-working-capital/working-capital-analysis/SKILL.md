...
description: Analyse receivables, inventory, payables, DSO, DIO, DPO, cash conversion, and cash-release potential. Use for working-capital performance and cash-tied-up questions.
---
...
Analyse receivables, payables, inventory, and operating working capital to identify cash tied up in operations.
...
- balance sheet or working-capital schedules
- revenue and COGS
- period
...
Use average balances for DSO/DPO/DIO where the data supports it, and disclose the day-count convention.
...
1. Calculate working-capital balances and changes.
2. Calculate DSO, DPO, DIO, and cash conversion cycle where data supports them.
3. Compare trends over time.
4. Quantify cash tied up in deterioration versus a selected benchmark.
5. Identify operational causes and realistic improvement levers.
6. Estimate cash-release potential separately from accounting profit impact.
...
- rapid working-capital growth versus sales
- inventory ageing or obsolescence
- DSO deterioration hidden by revenue growth
- stretching payables beyond sustainable supplier terms
