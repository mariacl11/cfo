---
name: payables-analysis
description: Analyse accounts payable ageing, supplier concentration, overdue obligations, payment timing, and near-term cash load. Use for AP and supplier-payment questions.
---
...
Analyse supplier obligations, payment timing, concentration, and short-term liquidity pressure.
...
Do not assume the company can extend supplier terms unilaterally.
...
1. Validate due dates and outstanding balances.
2. Bucket payables by age and due date.
3. Identify critical, overdue, and non-critical suppliers.
4. Assess concentration and near-term payment load.
5. Identify legitimate scheduling opportunities without assuming unilateral term changes.
6. Feed committed payments into cash forecasting.
...
- critical suppliers materially overdue
- large duplicate-looking invoices
- negative AP balances
- payments scheduled before contractual due dates despite cash pressure
