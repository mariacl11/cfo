...
description: Estimate enterprise or equity value using suitable DCF, earnings, or comparable-multiple methods with explicit assumptions and sensitivities.
---
...
Estimate company or equity value using methods appropriate to the available data and business model.
...
- financial history
- forecast or maintainable earnings
- valuation date
...
Keep enterprise value and equity value distinct. State valuation date and all key assumptions.
...
1. Choose appropriate valuation methods.
2. Normalise earnings or cash flows where needed.
3. Build DCF only when forecast quality supports it.
4. Apply comparable multiples only to genuinely comparable metrics.
5. Bridge enterprise value to equity value.
6. Run sensitivity around the assumptions that drive value most.
...
- negative or unstable denominator used for a multiple
- terminal value dominating DCF without disclosure
- debt and cash omitted from EV-to-equity bridge
- mixing equity-value and enterprise-value multiples
