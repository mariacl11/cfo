...
description: Appraise an investment using incremental cash flows, NPV, IRR, payback, working capital, terminal effects, sensitivity, and downside analysis.
---
...
Evaluate an investment or capital project using cash-flow-based return measures and scenario analysis.
...
Use incremental cash flows. NPV should be primary where IRR produces ambiguous rankings.
...
1. Build incremental cash flows.
2. Exclude sunk costs.
3. Include working-capital and terminal effects where relevant.
4. Calculate NPV, IRR, and payback when meaningful.
5. Run sensitivity and downside cases.
6. Compare alternatives on consistent timing and assumptions.
...
- accounting profit substituted for cash flow
- IRR used alone for mutually exclusive projects
- unrealistic terminal value
- benefits beginning before implementation completes
